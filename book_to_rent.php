...
<div class="container-fluid">
    <form action="" id="book-form">
        ...
        <div class="form-group">
            <label for="date_start" class="control-label">Fecha de Recogida</label>
            <input type="date" name="date_start" id="date_start" class="form-control form-conrtrol-sm rounded-0" value="" required>
        </div>
        <div class="form-group">
            <label for="date_end" class="control-label">Fecha de Entrega</label>
        ...
        <div class="form-group">
            <label for="rent_days" class="control-label">Días de alquiler</label>
    ...
    $(function(){
        $('#date_start, #date_end').change(function(){
            ...
            if(de < ds){
                ...
                $('#msg').text("Selección de Fechas Inválida")
                return false;
            }
            ...
            $.ajax({
                ...
                error:err=>{
                    console.log(err)
                    alert_toast('Ocurrió un error al validar la disponibilidad','error')
        ...
        $('#book-form').submit(function(e){
            ...
            if(_this.find('.border-danger').length > 0){
                alert_toast('No se puede continuar con el envío debido a entradas no válidas en algunos campos. Favor verificar.','warning')
                return false;
            }
            $('.err-msg').remove();
            start_loader();
