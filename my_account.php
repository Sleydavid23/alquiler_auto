        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    ...
                    <a href="./?p=edit_account" class="btn btn btn-dark btn-flat"><div class="fa fa-user-cog"></div> Gestionar Cuenta</a>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small><span class="text-muted">Devolución: </span><?php echo date("Y-m-d",strtotime($row['date_end'])) ?></small>
                                </td>
                                ...
                                <td align="center">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <a class="dropdown-item view_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-th-list text-dark"></span> Ver Detalles</a>
                                    </div>
                                </td>
                            </tr>
                            <?php endwhile; ?>
...
<script>
    $(function(){
        $('.view_data').click(function(){
            uni_modal("Detalles de Orden","./admin/bookings/view_booking.php?view=user&id="+$(this).attr('data-id'),'large')
        })
        $('table').dataTable();
