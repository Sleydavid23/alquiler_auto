        ...
        <div class="row  align-items-center h-100">
            ...
            <div class="col-lg-7">
                ...
                <div class="form-group d-flex justify-content-between">
                    <a href="javascript:void()" id="login-show">Ya tienes una cuenta? Accede aquí</a>
                    <button class="btn btn-primary btn-flat">Regístrate</button>
                </div>
            </div>
        </div>
    </form>
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(typeof resp == 'object' && resp.status == 'success'){
                        alert_toast("Cuenta registrada exitósamente",'success')
                        setTimeout(function(){
                            location.reload()
                        },2000)
