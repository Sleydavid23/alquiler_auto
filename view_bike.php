    ...
    <div class="container px-4 px-lg-5 my-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <p class="m-0"><small>Marca: <?php echo $brand ?></small> <br>
                <small><?php echo $category ?></small>
                </p>
                <div class="fs-5 mb-5">
                &#x24; <span id="price"><?php echo number_format($daily_rate) ?></span>
                <br>
                <span><small><b>Unidades Disponibles:</b> <span id="avail"><?php echo $quantity ?></span></small></span>
                </div>
                <button class="btn btn-outline-dark flex-shrink-0" type="button" id="book_bike">
                    <i class="bi-cart-fill me-1"></i>
                    Reservar este automovil
                </button>
...
<section class="py-5 bg-light">
    <div class="container px-4 px-lg-5 mt-5">
        <h2 class="fw-bolder mb-4">Vehículos Relacionados</h2>
                ...
                <div class="card h-100 bike-item">
                    ...
                    <div class="card-body p-4">
                        <div class="">
                            ...
                            <p class="m-0"><small>Marca: <?php echo $row['brand'] ?></small> <br>
...
<script>
    $(function(){
        ...
        $('#book_bike').click(function(){
            ...
            uni_modal("Reserva de Alquiler de Automóviles","book_to_rent.php?id=<?php echo isset($id) ? $id : '' ?>",'mid-large')
        })
    })
</script>