...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Actualizar ": "Crear Nuevo " ?> Autómovil</h3>
	</div>
	<div class="card-body">
		<form action="" id="bike-form">
            ...
            <div class="form-group">
				<label for="brand_id" class="control-label">Categoría de Marca</label>
                <select name="brand_id" id="brand_id" class="custom-select select2" required>
                <option value="" selected="" disabled="">Selecciona la Categoría primero</option>
                <?php
			...
			<div class="form-group">
				<label for="bike_model" class="control-label">Modelo</label>
            ...
            <div class="form-group">
                <label for="quantity" class="control-label">Unidades Disponibles</label>
            ...
            <div class="form-group">
                <label for="daily_rate" class="control-label">Tarifa Diaria</label>
            ...
            <div class="form-group">
				<label for="" class="control-label">Miniatura</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="bike-form">Guardar</button>
		<a class="btn btn-flat btn-default" href="?page=bike">Cancelar</a>
	</div>
</div>
<script>
    ...
    function delete_img($path){
        ...
        $.ajax({
            ...
            error:err=>{
                console.log(err)
                alert_toast("Ocurrió un error eliminando la imagen","error");
                end_loader()
            },
            success:function(resp){
                ...
                if(typeof resp =='object' && resp.status == 'success'){
                    ...
                    alert_toast("Imagen Eliminada Exitosamente","success");
                }else{
                    console.log(resp)
                    alert_toast("Ocurrió un Error Eliminando la Imagen","error");
                }
	...
	$(document).ready(function(){
        $('.rem_img').click(function(){
            _conf("Segur@ deseas eliminar esta imagen permanentemente?",'delete_img',["'"+$(this).attr('data-path')+"'"])
        })
