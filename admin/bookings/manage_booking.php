...
<div class="container-fluid">
    <form action="" id="book-form">
        <p><b>Categoría del Vehículo:</b> <?php echo $bike_meta['category'] ?></p>
        <p><b>Marca del Vehículo:</b> <?php echo $bike_meta['brand'] ?></p>
        <p><b>Modelo del Vehículo:</b> <?php echo $bike_meta['bike_model'] ?></p>
        ...
        <div class="form-group">
            <label for="date_start" class="control-label">Fecha Recogida</label>
        ...
        <div class="form-group">
            <label for="date_end" class="control-label">Fecha Retorno</label>
        ...
        <div class="form-group">
            <label for="rent_days" class="control-label">Días del Alquiler</label>
        ...
        <div class="form-group">
            <label for="daily_rate" class="control-label">Tarifa Diaría Vehículo</label>
        ...
        <div class="form-group">
            <label for="amount" class="control-label">Monto Total</label>
        ...
        <div class="form-group">
            ...
            <select name="status" id="" class="custom-select custol-select-sm">
                ...
                <option value="1" <?php echo $status == 1 ? "selected" : '' ?>>Confirmado</option>
                <option value="2" <?php echo $status == 2 ? "selected" : '' ?>>Cancelado</option>
                <option value="5" <?php echo $status == 3 ? "selected" : '' ?>>Recogida</option>
                <option value="3" <?php echo $status == 4 ? "selected" : '' ?>>Retorno</option>
            </select>
        </div>
    </form>
</div>
    ...
    $(function(){
        $('#date_start, #date_end').change(function(){
            ...
            if(de < ds){
                ...
                $('#msg').text("Fechas Seleccionada Inválidas")
                return false;
            }
            ...
            $.ajax({
                ...
                error:err=>{
                    console.log(err)
                    alert_toast('Ocurrió un error verificando la disponibilidad','error')
        ...
        $('#book-form').submit(function(e){
            ...
            if(_this.find('.border-danger').length > 0){
                alert_toast('No se puede continuar con el envío debido a entradas no válidas en algunos campos.','warning')
                return false;
            }
            $('.err-msg').remove();
            start_loader();
