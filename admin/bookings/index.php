					...
					?>
						<tr>
							...
							<td>
								...
								<small><span class="text-muted">Retorno: </span><?php echo date("Y-m-d",strtotime($row['date_end'])) ?></small>
							</td>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("¿Estás segur@ de eliminar esta reserva de forma permanente?","delete_booking",[$(this).attr('data-id')])
		})
		$('.view_data').click(function(){
			uni_modal('Detalles Reserva','bookings/view_booking.php?id='+$(this).attr('data-id'),'mid-large')
		})
		$('.table').dataTable();
	})
