...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-primary bg-navy border-0"><span class="fas fa-plus"></span>  Crear Nueva Marca</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Agregar Nueva Marca", 'maintenance/manage_brand.php')
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Editar Detalles de Marca", 'maintenance/manage_brand.php?id='+$(this).attr('data-id'))
		})
