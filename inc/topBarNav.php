                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="./?p=view_categories">Todas las Categorías</a>
                            <?php 
                        ...
                        <li class="nav-item"><a class="nav-link" href="./?p=about">Acerca de</a></li>
                    </ul>
                    <div class="d-flex align-items-center">
                      <?php if(!isset($_SESSION['userdata']['id'])): ?>
                        <button class="btn btn-outline-light ml-2" id="login-btn" type="button">Ingresar</button>
                        <?php else: ?>
                            <a href="./?p=my_account" class="text-light  nav-link"><b> Hola, <?php echo $_settings->userdata('firstname')?>!</b></a>
